...
export default function Mascot({ mood = "happy" }: MascotProps) {
  ...
  return (
    <div className="relative">
      <div className="bg-gradient-to-br from-[#0F4C81] via-[#4A7BA7] to-[#91A8D0] rounded-full w-24 h-24 md:w-32 md:h-32 flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow">
      ...
      <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-white px-4 py-1 rounded-full shadow-md">
        <p className="text-xs md:text-sm font-bold text-[#0F4C81]">Keep going!</p>
      </div>
    </div>
  )
}
